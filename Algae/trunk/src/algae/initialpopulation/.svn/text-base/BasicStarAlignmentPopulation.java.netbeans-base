...
import algae.staralignment.RandomStarAlignOrder;
 ...
 * @author sergio
 */
public class BasicStarAlignmentPopulation implements InitialPopulation {

    private int populationSize = 0;

    public BasicStarAlignmentPopulation(int size) {
        populationSize = size;
    }
    ...
    public ArrayList<Chromossome> generate() {
        ...
        for (int i=0;i<populationSize;i++){
            RandomStarAlignOrder order = new RandomStarAlignOrder(sequenceCount);
