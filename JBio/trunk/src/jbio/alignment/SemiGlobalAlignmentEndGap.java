 ...
 * @author sergio
 */
public class SemiGlobalAlignmentEndGap extends PairWiseAlignment {

    private Sequence sequence1;
    private Sequence sequence2;
    private Matrix scoreMatrix;

    public SemiGlobalAlignmentEndGap(Sequence sequence1, Sequence sequence2, Matrix scoreMatrix){
    ...
    public double[][] alignmentMatrix() {
         ...
         if (sequence1!=null && sequence2!=null && scoreMatrix != null &&
            ...
            for (int i=1;i<matrix.length;i++){
                matrix[i][0] = MatrixUtil.getScore(scoreMatrix, seq1[i-1], '-');
            }

            for (int i=1;i<matrix[0].length;i++){
                matrix[0][i] = MatrixUtil.getScore(scoreMatrix, seq2[i-1], '-');
            }
