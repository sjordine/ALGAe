 ...
 * @author sergio
 */
public class GlobalAlignment extends PairWiseAlignment {
    ...
    public GlobalAlignment(Sequence sequence1, Sequence sequence2, Matrix scoreMatrix){
        ...
        double[][] matrix = null;
         ...
         if (sequence1!=null && sequence2!=null && scoreMatrix != null &&
            ...
            for (int i=1;i<matrix.length;i++){
                matrix[i][0] = MatrixUtil.getScore(scoreMatrix, seq1[i-1], '-')*i;
            }

            for (int i=1;i<matrix[0].length;i++){
                matrix[0][i] = MatrixUtil.getScore(scoreMatrix, seq2[i-1], '-')*i;
            }
