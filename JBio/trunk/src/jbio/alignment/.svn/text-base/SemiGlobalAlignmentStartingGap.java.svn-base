 ...
 * @author sergio
 */
public class SemiGlobalAlignmentStartingGap extends PairWiseAlignment {

    private Sequence sequence1;
    private Sequence sequence2;
    private Matrix scoreMatrix;

    public SemiGlobalAlignmentStartingGap(Sequence sequence1, Sequence sequence2, Matrix scoreMatrix){
